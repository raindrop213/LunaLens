...
// @author       Raindrop213
// @match        *://**/*
// @updateURL    https://raw.githubusercontent.com/raindrop213/LunaLens/main/luna-lens.meta.js
// @downloadURL  https://raw.githubusercontent.com/raindrop213/LunaLens/main/luna-lens.user.js
// @grant        none
// @run-at       document-end
// ==/UserScript==
...
(function() {
    ...
    const getLunaLensCode = function() {
        return function initFunction() {
            if (window.__lunaLensInjected) return;
            window.__lunaLensInjected = true;
        ...
        let currentWord = '';
        let currentAudio = null; // 当前朗读的元素和音频
        ...
        console.log("[LunaLens] 注入完成：", window.location.href);
    }
}
